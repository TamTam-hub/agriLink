            ...
            child: Column(
              ...
              children: [
                _buildFAQItem(
                  ...
                  answer: 'Browse products in the marketplace, add items to your cart, and proceed to checkout.',
                ),
                const SizedBox(height: AppSpacing.md),
                _buildFAQItem(
                  question: 'How do I become a farmer?',
                  answer: 'Sign up as a farmer during registration and start adding your products to the marketplace.',
                ),
                const SizedBox(height: AppSpacing.md),
                _buildFAQItem(
